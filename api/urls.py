...
urlpatterns = [
    ...
    path('passation_service', PassationController.as_view(), name='passation_service'),
    path('passation_service/<int:id>/', PassationController.as_view(), name='passation_service-detail'),
