...
urlpatterns = [
    ...
    path('contrats/<int:id>/', ContratController.as_view(), name='contrat-detail'),
    path('typecontrats',TypeContratController.as_view(),name='typecontrats'),
    path('typecontrats/<int:id>/', TypeContratController.as_view(), name='typecontrats-detail'),
