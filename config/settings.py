...
JWT_TOKEN_DURATION = 3600  # Durée en secondes (1 heure)
DUREE_VALIDATION_INSCRIPTION = 300 # Durée en secondes (5 minutes)

# Configuration de l'expéditeur pour les emails
